    ...
    <section id="why-choose" className="px-2 sm:px-8 py-8 sm:py-12 bg-black border-b border-gray-800">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-stretch gap-8">
        ...
        <div className="flex-1 flex flex-col justify-center items-start text-left max-w-xl" data-aos="fade-left" data-aos-duration="800">
          ...
          <button className="bg-green-400 text-black px-6 py-2 rounded-full font-semibold hover:bg-green-300 active:scale-95 transition-all duration-200 shadow-lg">Contact us</button>
        </div>
      </div>
    </section>
    {/* CTA Section Below */}
    <section className="mt-6 px-2 sm:px-8" data-aos="fade-up" data-aos-duration="800">
      <div className="bg-[#181A23] rounded-2xl flex flex-col md:flex-row items-center justify-between p-6 sm:p-10 gap-6 shadow-lg">
        <div className="flex-1 min-w-0">
          ...
          <button className="bg-green-400 text-black px-6 py-2 rounded-lg font-semibold hover:bg-green-300 active:scale-95 transition-all duration-200 shadow-lg">Get your free proposal</button>
        </div>
